...
const { getAllTours, getTour, deleteTour, getDistances, updateTour, createTour, aliasTopTours, getTourStats, getMonthlyPlan, getToursWithin } = require('../controllers/tourController')
